import { isServer as Ot, unsafeCSS as Ie, LitElement as no, html as g, nothing as G, svg as B } from "lit";
import { property as C, query as gt, customElement as V, state as re } from "lit/decorators.js";
...
import { map as lt } from "lit/directives/map.js";
import { repeat as de } from "lit/directives/repeat.js";
import { unsafeHTML as io } from "lit/directives/unsafe-html.js";
const so = "/";
function Ja(e, t, r) {
  const a = Object.keys(e), n = oo(a);
  return a.reduce((i, s) => {
...
function uo(e) {
  return e === ze.lineFeed || e === ze.carriageReturn || e === ze.lineSeparator || e === ze.paragraphSeparator;
}
function ho(e) {
  const t = [];
  let r = 0, a = 0;
  ...
  for (n(0); r < e.length; ) {
    ...
    switch (r++, i) {
      case ze.carriageReturn:
        e.charCodeAt(r) === ze.lineFeed && r++, n(r);
        break;
      case ze.lineFeed:
        n(r);
        break;
      default:
        i > ze.maxAsciiCharacter && uo(i) && n(r);
        break;
    }
  }
  return t.push(a), t;
...
class fo {
   ...
   */
  getMutatedLines() {
    return kr(this.sourceFile), this.sourceFile.getMutationLines(this);
  }
  /**
   * Retrieves the original source lines for this mutant, to be shown in a diff view.
   */
  getOriginalLines() {
    return kr(this.sourceFile), this.sourceFile.getLines(this.location);
  }
  /**
   ...
   */
  get fileName() {
    return kr(this.sourceFile), this.sourceFile.name;
  }
...
class qn {
  #e;
  getLineMap() {
    return Xa(this.source), this.#e ?? (this.#e = ho(this.source));
  }
  /**
...
class Wn {
  ...
  updateMetrics() {
    if (this.file === void 0) {
      ...
      if (t.length === 0)
        return;
      t[0].tests ? this.metrics = Tr(t) : this.metrics = rr(t);
      return;
    }
    this.file.tests ? this.metrics = Tr([this.file]) : this.metrics = rr([this.file]);
  }
  #e(t) {
    const r = [];
...
class vo {
   ...
   */
  getLines() {
    return en(this.sourceFile), mo(this.location), this.sourceFile.getLines(this.location);
  }
  /**
   * Helper property to retrieve the source file name
   * @throws When the `sourceFile` is not defined.
...
const tn = NaN, rn = "All files", bo = "All tests";
function yo(e) {
  const { files: t, testFiles: r, projectRoot: a = "" } = e, n = Ja(t, a, (i, s) => new go(i, s));
  if (r && Object.keys(r).length) {
    const i = Ja(r, a, (s, o) => new Un(s, o));
    return ko(Object.values(n).flatMap((s) => s.mutants), Object.values(i).flatMap((s) => s.tests)), {
      systemUnderTestMetrics: xr(rn, n, rr),
      testMetrics: xr(bo, i, Tr)
    };
  }
  return {
    systemUnderTestMetrics: xr(rn, n, rr),
...
function Kn(e, t, r) {
  const a = r(Object.values(t)), n = wo(t, r);
  return new Wn(e, n, a);
}
function Vn(e, t, r) {
  return new Wn(e, [], r([t]), t);
}
function wo(e, t) {
  const r = po(Object.entries(e), (a) => a[0].split("/")[0]);
...
function rr(e) {
  const t = e.flatMap((S) => S.mutants), r = (S) => t.filter((P) => P.status === S).length, a = r("Pending"), n = r("Killed"), i = r("Timeout"), s = r("Survived"), o = r("NoCoverage"), l = r("RuntimeError"), u = r("CompileError"), m = r("Ignored"), _ = i + n, x = s + o, v = _ + s, $ = x + _, y = l + u;
  return {
    pending: a,
    killed: n,
    timeout: i,
...
var Er = function(e, t) {
  return Er = Object.setPrototypeOf || { __proto__: [] } instanceof Array && function(r, a) {
    r.__proto__ = a;
  } || function(r, a) {
...
function _o(e, t, r) {
  ...
  function u(v) {
    v.value instanceof nt ? Promise.resolve(v.value.v).then(m, _) : x(i[0][2], v);
  }
  function m(v) {
    l("next", v);
  }
...
function $o(e) {
  ...
  return t ? t.call(e) : (e = typeof ct == "function" ? ct(e) : e[Symbol.iterator](), r = {}, a("next"), a("throw"), a("return"), r[Symbol.asyncIterator] = function() {
    return this;
  }, r);
  function a(i) {
    r[i] = e[i] && function(s) {
    ...
    if (!this.closed) {
      ...
      if (s)
        if (this._parentage = null, Array.isArray(s))
          try {
            for (var o = ct(s), l = o.next(); !l.done; l = o.next()) {
              var u = l.value;
              u.remove(this);
            }
          } catch (y) {
      ...
      if (z(m))
        try {
          ...
          i = y instanceof _r ? y.errors : [y];
        }
      var _ = this._finalizers;
      if (_) {
        this._finalizers = null;
        try {
          for (var x = ct(_), v = x.next(); !v.done; v = x.next()) {
            var $ = v.value;
            try {
              an($);
            } catch (y) {
              i = i ?? [], y instanceof _r ? i = Tt(Tt([], ut(i)), ut(y.errors)) : i.push(y);
            }
          }
        } catch (y) {
          a = { error: y };
...
function Yn(e) {
  return e instanceof mt || e && "closed" in e && z(e.remove) && z(e.add) && z(e.unsubscribe);
}
function an(e) {
  z(e) ? e() : e.unsubscribe();
}
var So = {
  ...
  setTimeout: function(e, t) {
    for (var r = [], a = 2; a < arguments.length; a++)
      r[a - 2] = arguments[a];
    return setTimeout.apply(void 0, Tt([e, t], ut(r)));
  },
...
var _a = (function(e) {
  ...
  function t(r) {
    ...
    return a.isStopped = !1, r ? (a.destination = r, Yn(r) && r.add(a)) : a.destination = To, a;
  }
...
var te = (function() {
  ...
  return e.prototype.lift = function(t) {
    ...
    var n = this, i = zo(t) ? t : new zr(t, r, a);
    return Zt(function() {
...
function zo(e) {
  return e && e instanceof _a || Po(e) && Yn(e);
}
function Fo(e) {
  return z(e?.lift);
}
...
var Oo = (function(e) {
  ...
  return t.prototype.lift = function(r) {
    ...
    Zt(function() {
      ...
      if (a._throwIfClosed(), !a.isStopped) {
        ...
        try {
          for (var s = ct(a.currentObservers), o = s.next(); !o.done; o = s.next()) {
            var l = o.value;
            l.next(r);
          }
        } catch (u) {
    ...
    return i || s ? Gn : (this.currentObservers = null, o.push(r), new mt(function() {
      a.currentObservers = null, ar(o, r);
    }));
  ...
  setInterval: function(e, t) {
    for (var r = [], a = 2; a < arguments.length; a++)
      r[a - 2] = arguments[a];
    return setInterval.apply(void 0, Tt([e, t], ut(r)));
  },
  ...
  return t.prototype.schedule = function(r, a) {
    ...
    if (!this.closed) {
      ...
      this.work = this.state = this.scheduler = null, this.pending = !1, ar(i, this), a != null && (this.id = this.recycleAsyncId(n, a, null)), this.delay = null, e.prototype.unsubscribe.call(this);
    }
  }, t;
})(Do), ln = (function() {
  function e(t, r) {
...
})(ln), Ca = new Ro(Bo), jo = Ca, Xn = new te(function(e) {
  return e.complete();
});
function ei(e) {
...
function ci(e) {
  return _o(this, arguments, function() {
    var r, a, n, i;
...
function Vo(e) {
  return new te(function(t) {
    var r, a;
    try {
      for (var n = ct(e), i = n.next(); !i.done; i = n.next()) {
        var s = i.value;
...
function Ho(e, t) {
  ...
  return xo(this, void 0, void 0, function() {
    ...
    return Zn(this, function(l) {
      switch (l.label) {
        case 0:
          l.trys.push([0, 5, 6, 11]), r = $o(e), l.label = 1;
        case 1:
          return [4, r.next()];
        case 2:
...
function hi(e, t) {
  return t === void 0 && (t = 0), vt(function(r, a) {
    r.subscribe(Ge(a, function(n) {
      return He(a, e, function() {
        return a.next(n);
      }, t);
    }, function() {
      return He(a, e, function() {
...
function Qo(e, t) {
  return new te(function(r) {
    var a;
    return He(r, t, function() {
      a = e[oi](), He(r, t, function() {
        var n, i, s;
        try {
...
function Aa(e, t) {
  return vt(function(r, a) {
    var n = 0;
    r.subscribe(Ge(a, function(i) {
      a.next(e.call(t, i, n++));
    }));
  });
}
...
function nl(e, t) {
  return al(t) ? e.apply(void 0, Tt([], ut(t))) : e(t);
}
function il(e) {
...
function sl(e, t, r, a, n, i, s, o) {
  var l = [], u = 0, m = 0, _ = !1, x = function() {
    _ && !l.length && !u && t.complete();
  }, v = function(y) {
    return u < a ? $(y) : l.push(y);
  }, $ = function(y) {
    u++;
    var S = !1;
    De(r(y, m++)).subscribe(Ge(t, function(P) {
      t.next(P);
    }, function() {
      S = !0;
    }, void 0, function() {
  ...
  return e.subscribe(Ge(t, v, function() {
    _ = !0, x();
  })), function() {
  };
}
function Ta(e, t, r) {
  return r === void 0 && (r = 1 / 0), z(t) ? Ta(function(a, n) {
    return Aa(function(i, s) {
      return t(a, i, n, s);
    })(De(e(a, n)));
  }, r) : (typeof t == "number" && (r = t), vt(function(a, n) {
    return sl(a, n, e, r);
  }));
}
function ol(e) {
...
var ll = ["addListener", "removeListener"], cl = ["addEventListener", "removeEventListener"], ul = ["on", "off"];
function Et(e, t, r, a) {
  if (z(r) && (a = r, r = void 0), a)
    return Et(e, t, r).pipe(il(a));
  var n = ut(pl(e) ? cl.map(function(o) {
    return function(l) {
      return e[o](t, l, r);
    };
  }) : dl(e) ? ll.map(cn(e, t)) : hl(e) ? ul.map(cn(e, t)) : [], 2), i = n[0], s = n[1];
  if (!i && Ma(e))
...
function dl(e) {
  return z(e.addListener) && z(e.removeListener);
}
function hl(e) {
  return z(e.on) && z(e.off);
}
function pl(e) {
  return z(e.addEventListener) && z(e.removeEventListener);
}
function fl(e, t, r) {
  r === void 0 && (r = jo);
  var a = -1;
  return ei(t) ? r = t : a = t, new te(function(n) {
    var i = rl(e) ? +e - r.now() : e;
    i < 0 && (i = 0);
    var s = 0;
...
function gl(e, t) {
  return t === void 0 && (t = Ca), fl(e, e, t);
}
function ml() {
  for (var e = [], t = 0; t < arguments.length; t++)
    e[t] = arguments[t];
  var r = ri(e), a = No(e, 1 / 0), n = e;
  return n.length ? n.length === 1 ? De(n[0]) : ol(a)(gi(n, r)) : Xn;
}
function vl(e) {
  return vt(function(t, r) {
    var a = !1, n = null;
    t.subscribe(Ge(r, function(i) {
      a = !0, n = i;
    })), De(e).subscribe(Ge(r, function() {
      if (a) {
        a = !1;
        var i = n;
        n = null, r.next(i);
...
function bl(e, t) {
  return t === void 0 && (t = Ca), vl(gl(e, t));
}
function yl(e, t, r) {
  var a = z(e) || t || r ? { next: e, error: t, complete: r } : e;
  return a ? vt(function(n, i) {
    var s;
    (s = a.subscribe) === null || s === void 0 || s.call(a);
    var o = !0;
    n.subscribe(Ge(i, function(l) {
      var u;
...
var un = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {}, $r = { exports: {} }, dn;
function kl() {
    ...
    var r = (function(a) {
          ...
          insertBefore: function(p, c, f, d) {
            ...
            for (var w in h)
              if (h.hasOwnProperty(w)) {
                ...
                f.hasOwnProperty(w) || (b[w] = h[w]);
              }
            var T = d[p];
            return d[p] = b, o.languages.DFS(o.languages, function(O, M) {
              M === T && O != p && (this[O] = b);
            }), b;
          },
          ...
          DFS: function p(c, f, d, h) {
            ...
            for (var w in c)
              if (c.hasOwnProperty(w)) {
                f.call(c, w, c[w], d || w);
                var k = c[w], T = o.util.type(k);
                T === "Object" && !h[b(k)] ? (h[b(k)] = !0, p(k, f, null, h)) : T === "Array" && !h[b(k)] && (h[b(k)] = !0, p(k, f, w, h));
              }
          }
        },
        plugins: {},
      ...
      l.stringify = function p(c, f) {
        ...
        for (var k in h.attributes)
          w += " " + k + '="' + (h.attributes[k] || "").replace(/"/g, "&quot;") + '"';
        return "<" + h.tag + ' class="' + h.classes.join(" ") + '"' + w + ">" + h.content + "</" + h.tag + ">";
      };
      function u(p, c, f, d) {
        p.lastIndex = c;
        var h = p.exec(f);
        ...
        for (var w in f)
          if (!(!f.hasOwnProperty(w) || !f[w])) {
            ...
            for (var T = 0; T < k.length; ++T) {
              if (b && b.cause == w + "," + T)
                return;
              var O = k[T], M = O.inside, A = !!O.lookbehind, Me = !!O.greedy, J = O.alias;
              if (Me && !O.pattern.global) {
                var tt = O.pattern.toString().match(/[imsuy]*$/)[0];
                O.pattern = RegExp(O.pattern.source, tt + "g");
              }
              for (var me = O.pattern || O, R = d.next, L = h; R !== c.tail && !(b && L >= b.reach); L += R.value.length, R = R.next) {
                var Q = R.value;
                ...
                if (!(Q instanceof l)) {
                  var ve = 1, ae;
                  if (Me) {
                    if (ae = u(me, L, p, A), !ae || ae.index >= p.length)
                      break;
                    var Bt = ae.index, ro = ae.index + ae[0].length, Ae = L;
                    for (Ae += R.value.length; Bt >= Ae; )
                      R = R.next, Ae += R.value.length;
                    if (Ae -= R.value.length, L = Ae, R.value instanceof l)
                      continue;
                    for (var kt = R; kt !== c.tail && (Ae < ro || typeof kt.value == "string"); kt = kt.next)
                      ve++, Ae += kt.value.length;
                    ve--, Q = p.slice(L, Ae), ae.index -= L;
                  } else if (ae = u(me, 0, Q, A), !ae)
                    continue;
                  var Bt = ae.index, Rt = ae[0], br = Q.slice(0, Bt), Ya = Q.slice(Bt + Rt.length), yr = L + Q.length;
                  b && yr > b.reach && (b.reach = yr);
                  var jt = R.prev;
                  br && (jt = x(c, jt, br), L += br.length), v(c, jt, ve);
                  var ao = new l(w, M ? o.tokenize(Rt, M) : Rt, J, Rt);
                  if (R = x(c, jt, ao), Ya && x(c, R, Ya), ve > 1) {
                    var wr = {
                      cause: w + "," + T,
                      reach: yr
                    };
                    m(p, c, f, R.prev, L, wr), b && wr.reach > b.reach && (b.reach = wr.reach);
                  }
                }
              }
            }
      ...
      if (!o.manual) {
        ...
        P === "loading" || P === "interactive" && y && y.defer ? document.addEventListener("DOMContentLoaded", S) : window.requestAnimationFrame ? window.requestAnimationFrame(S) : window.setTimeout(S, 16);
      }
      return o;
    })(t);
...
function _l() {
  return mn || (mn = 1, (function(e) {
    function t(L, Q) {
      return L.replace(/<<(\d+)>>/g, function(ve, ae) {
        return "(?:" + Q[+ae] + ")";
      });
    }
    function r(L, Q, ve) {
    ...
    function i(L) {
      return "\\b(?:" + L.trim().replace(/ /g, "|") + ")\\b";
    }
    var s = i(n.typeDeclaration), o = RegExp(i(n.type + " " + n.typeDeclaration + " " + n.contextual + " " + n.other)), l = i(n.typeDeclaration + " " + n.contextual + " " + n.other), u = i(n.type + " " + n.typeDeclaration + " " + n.other), m = a(/<(?:[^<>;=+\-*/%&|^]|<<self>>)*>/.source, 2), _ = a(/\((?:[^()]|<<self>>)*\)/.source, 2), x = /@?\b[A-Za-z_]\w*\b/.source, v = t(/<<0>>(?:\s*<<1>>)?/.source, [x, m]), $ = t(/(?!<<0>>)<<1>>(?:\s*\.\s*<<1>>)*/.source, [l, v]), y = /\[\s*(?:,\s*)*\]/.source, S = t(/<<0>>(?:\s*(?:\?\s*)?<<1>>)*(?:\s*\?)?/.source, [$, y]), P = t(/[^,()<>[\];=+\-*/%&|^]|<<0>>|<<1>>|<<2>>/.source, [m, _, y]), p = t(/\(<<0>>+(?:,<<0>>+)+\)/.source, [P]), c = t(/(?:<<0>>|<<1>>)(?:\s*(?:\?\s*)?<<2>>)*(?:\s*\?)?/.source, [p, $, y]), f = {
      keyword: o,
      punctuation: /[<>()?,.:[\]]/
    ...
    var w = h + "|" + d, k = t(/\/(?![*/])|\/\/[^\r\n]*[\r\n]|\/\*(?:[^*]|\*(?!\/))*\*\/|<<0>>/.source, [w]), T = a(t(/[^"'/()]|<<0>>|\(<<self>>*\)/.source, [k]), 2), O = /\b(?:assembly|event|field|method|module|param|property|return|type)\b/.source, M = t(/<<0>>(?:\s*\(<<1>>*\))?/.source, [$, T]);
    e.languages.insertBefore("csharp", "class-name", {
      attribute: {
        // Attributes
        // [Foo], [Foo(1), Bar(2, Prop = "foo")], [return: Foo(1), Bar(2)], [assembly: Foo(Bar)]
        pattern: r(/((?:^|[^\s\w>)?])\s*\[\s*)(?:<<0>>\s*:\s*)?<<1>>(?:\s*,\s*<<1>>)*(?=\s*\])/.source, [O, M]),
        lookbehind: !0,
        greedy: !0,
        inside: {
          target: {
            pattern: r(/^<<0>>(?=\s*:)/.source, [O]),
            alias: "keyword"
          },
          "attribute-arguments": {
    ...
    var A = /:[^}\r\n]+/.source, Me = a(t(/[^"'/()]|<<0>>|\(<<self>>*\)/.source, [k]), 2), J = t(/\{(?!\{)(?:(?![}:])<<0>>)*<<1>>?\}/.source, [Me, A]), tt = a(t(/[^"'/()]|\/(?!\*)|\/\*(?:[^*]|\*(?!\/))*\*\/|<<0>>|\(<<self>>*\)/.source, [w]), 2), me = t(/\{(?!\{)(?:(?![}:])<<0>>)*<<1>>?\}/.source, [tt, A]);
    function R(L, Q) {
      return {
        interpolation: {
        ...
        function s(o) {
          for (var l = 0; l < o.length && !(n >= i.length); l++) {
            ...
            if (typeof u == "string" || u.content && typeof u.content == "string") {
              ...
              if ($ > -1) {
                ++n;
                var y = x.substring(0, $), S = new e.Token(a, e.tokenize(_, r.grammar), "language-" + a, _), P = x.substring($ + v.length), p = [];
                y && p.push.apply(p, s([y])), p.push(S), P && p.push.apply(p, s([P])), typeof u == "string" ? o.splice.apply(o, [l, 1].concat(p)) : u.content = p;
              }
...
const nr = (e, t) => g`<li title=${e.trim() || G} class="my-3 rounded-sm bg-white px-2 py-3 shadow-sm">${t}</li>`, Ue = (e, t) => g`<p title=${t?.trim() || G}>${e}</p>`, bi = (e) => g`<div class="mt-2 mr-6 mb-6 flex flex-col gap-4">${e}</div>`, I = (e, t) => g`<span role="img" aria-label="${t}">${e}</span>`, El = ":host([mode=closed]){height:0}:host([mode=half]){height:var(--spacing-drawer-half-open)}:host([mode=open]){height:50%}";
var yi = Object.defineProperty, Pl = Object.getOwnPropertyDescriptor, wi = (e) => {
  throw TypeError(e);
}, zl = (e, t, r) => t in e ? yi(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, It = (e, t, r, a) => {
  for (var n = a > 1 ? void 0 : a ? Pl(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (n = (a ? s(t, r, n) : s(n)) || n);
  return a && n && yi(t, r, n), n;
}, ki = (e, t, r) => zl(e, typeof t != "symbol" ? t + "" : t, r), xi = (e, t, r) => t.has(e) || wi("Cannot " + r), qt = (e, t, r) => (xi(e, t, "read from private field"), t.get(e)), Sr = (e, t, r) => t.has(e) ? wi("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), Cn = (e, t, r, a) => (xi(e, t, "write to private field"), t.set(e, r), r), Ht, _t, Fr;
const Fl = 120;
let Ye = class extends Be {
  constructor() {
    super(), Sr(this, Ht), Sr(this, _t), ki(this, "toggleReadMore", (e) => {
      this.mode === "open" ? this.mode = "half" : this.mode = "open", e.preventDefault(), e.stopImmediatePropagation();
    }), Sr(this, Fr, (e) => {
      e.key === "Escape" && (this.mode = "closed");
    }), this.mode = "closed", this.hasDetail = !1, Cn(this, _t, new AbortController()), Cn(this, Ht, new wl(this, {
      callback: (e) => {
  ...
  get toggleMoreLabel() {
    switch (this.mode) {
      case "half":
        return g`${I("🔼", "up arrow")} More`;
      case "open":
        return g`${I("🔽", "down arrow")} Less`;
      case "closed":
        return G;
    }
  }
  connectedCallback() {
    super.connectedCallback(), window.addEventListener("keydown", qt(this, Fr), { signal: qt(this, _t).signal });
  }
  disconnectedCallback() {
    qt(this, _t).abort(), super.disconnectedCallback();
  }
  render() {
    const e = this.mode === "open", t = qt(this, Ht).value;
    return g`<aside @click="${(r) => r.stopPropagation()}" class="mr-4 ml-6">
      ...
      >
        ...
        ${E(this.hasDetail && this.mode === "open", () => g`<slot name="detail"></slot>`)}
      </div>
    </aside>`;
  }
};
...
ki(Ye, "styles", [Ie(El), _e]);
It([
  C({ reflect: !0 })
], Ye.prototype, "mode", 2);
It([
  C({ reflect: !0, type: Boolean, attribute: "has-detail" })
], Ye.prototype, "hasDetail", 2);
It([
  C({ attribute: !1 })
], Ye.prototype, "toggleMoreLabel", 1);
It([
  gt("header")
], Ye.prototype, "header", 2);
Ye = It([
  V("mte-drawer")
], Ye);
function Ol(e) {
...
function Ll(e) {
  ...
  return t >= 0 && r <= (window.innerHeight || document.documentElement.clientHeight) - Fl;
}
const Mi = new Qn(), Dl = Ot ? Xn : ml(tl(1), Et(window, "hashchange").pipe(yl((e) => e.preventDefault()))).pipe(
...
let Y = class extends Ce {
  ...
  firstUpdated() {
    (this.path.length === 0 || this.path[0] !== ce.mutant && this.path[0] !== ce.test) && window.location.replace(bt(`${ce.mutant}`));
  }
  willUpdate(e) {
    this.report && (this.theme ??= oe(this, X, Lr).call(this), e.has("report") && oe(this, X, Pi).call(this, this.report), (e.has("path") || e.has("report")) && (oe(this, X, zi).call(this), oe(this, X, Fi).call(this))), e.has("src") && oe(this, X, Ei).call(this);
  }
  updated(e) {
  ...
  connectedCallback() {
    super.connectedCallback(), window.matchMedia("(prefers-color-scheme: dark)").addEventListener?.("change", D(this, Ir), { signal: D(this, Gt).signal }), this.subscriptions.push(Dl.subscribe((e) => this.path = e)), oe(this, X, Oi).call(this);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), D(this, Gt).abort(), this.subscriptions.forEach((e) => e.unsubscribe());
  }
  render() {
    return E(
      ...
      () => g`<mte-file-picker .rootModel="${this.rootModel}"></mte-file-picker>
          <div class="container space-y-4 bg-white pb-4 font-sans text-gray-800 transition-colors motion-safe:transition-max-width">
            ...
            <mte-result-status-bar
              detected="${xt(this.rootModel?.systemUnderTestMetrics.metrics.totalDetected)}"
              no-coverage="${xt(this.rootModel?.systemUnderTestMetrics.metrics.noCoverage)}"
              pending="${xt(this.rootModel?.systemUnderTestMetrics.metrics.pending)}"
              survived="${xt(this.rootModel?.systemUnderTestMetrics.metrics.survived)}"
              total="${xt(this.rootModel?.systemUnderTestMetrics.metrics.totalValid)}"
            ></mte-result-status-bar>
            ${E(
...
Lr = function() {
  ...
  return e || (Ot || window.matchMedia?.("(prefers-color-scheme: dark)")?.matches ? "dark" : "light");
};
Pi = function(e) {
  this.rootModel = yo(e), t((r, a) => {
    r.result = a, r.mutants.forEach((n) => D(this, vr).set(n.id, n));
  })(this.rootModel?.systemUnderTestMetrics), t((r, a) => {
    r.result = a, r.tests.forEach((n) => D(this, Pt).set(n.id, n));
...
Oi = function() {
  if (!this.sse)
    return;
  Wt(this, Ke, new EventSource(this.sse));
  const e = Et(D(this, Ke), "mutant-tested").subscribe((r) => {
    const a = JSON.parse(r.data);
    if (!this.report)
      return;
    const n = D(this, vr).get(a.id);
    if (n !== void 0) {
      Wt(this, ke, n);
      for (const [i, s] of Object.entries(a))
        D(this, ke)[i] = s;
      a.killedBy && a.killedBy.forEach((i) => {
        const s = D(this, Pt).get(i);
        s !== void 0 && (Wt(this, zt, s), s.addKilled(D(this, ke)), D(this, ke).addKilledBy(s));
      }), a.coveredBy && a.coveredBy.forEach((i) => {
        const s = D(this, Pt).get(i);
        s !== void 0 && (Wt(this, zt, s), s.addCovered(D(this, ke)), D(this, ke).addCoveredBy(s));
      });
    }
  }), t = Et(D(this, Ke), "mutant-tested").pipe(bl(Nl)).subscribe(() => {
    oe(this, X, Dr).call(this);
  });
  D(this, Mt).add(e), D(this, Mt).add(t), D(this, Ke).addEventListener("finished", () => {
    D(this, Ke)?.close(), oe(this, X, Dr).call(this), D(this, Mt).forEach((r) => r.unsubscribe());
  });
};
Dr = function() {
  D(this, ke)?.update(), D(this, zt)?.update(), Mi.next();
};
Ii = function() {
  return E(
    this.context.result,
    (e) => g`<h1 class="mt-4 text-5xl font-bold tracking-tight">
          ${e.name}${E(this.titlePostfix, (t) => g`<small class="text-light-muted ml-4 font-light">${t}</small>`)}
        </h1>`
  );
};
Li = function() {
...
Di = function() {
  return E(this.rootModel?.testMetrics, () => {
...
function Fa(e, t) {
  const r = za(t) ?? "plain";
  let a = r;
  return r === F.vue && (a = F.html), hn.highlight(e, hn.languages[a], a);
}
function Oa(e, t) {
  let r = [];
  const a = [], n = {
  ...
  let s = !1, o = 0;
  for (; o < e.length; ) {
    switch (s && !Yt(e[o]) && (u(), s = !1), e[o]) {
      case he.CarriageReturn:
        n.offset++;
        break;
      case he.NewLine:
  ...
  function $() {
    ...
    d && o++;
    const h = o;
    for (; !Yt(e[o]) && e[o] !== he.GT; )
      o++;
    const b = e.substring(h, o), w = P();
    return { elementName: b, attributes: w, isClosing: d };
  }
  function y(d) {
    i.push(d), l(_(d));
  }
  ...
  function f() {
    const d = o;
    for (; e[o] !== he.Semicolon; )
      o++;
    return e.substring(d, o + 1);
  }
}
function Yt(e) {
  return e === he.NewLine || e === he.Space || e === he.Tab;
}
const he = {
  CarriageReturn: "\r",
  NewLine: `
  ...
  constructor() {
    super(), Ne(this, q), Ne(this, $t), Ne(this, Br, (e) => {
      ...
      if (e.stopPropagation(), e.target instanceof Element) {
        ...
        r[a] ? (Z(this, q, We).call(this, r[a]), Mn()) : this.selectedMutant && (Z(this, q, We).call(this, this.selectedMutant), Mn());
      }
    }), Ne(this, Nr, () => {
      const e = this.selectedMutant ? (this.mutants.indexOf(this.selectedMutant) + 1) % this.mutants.length : 0;
      this.mutants[e] && Z(this, q, We).call(this, this.mutants[e]);
    }), Ne(this, qr, () => {
      ...
      this.mutants[e] && Z(this, q, We).call(this, this.mutants[e]);
    }), this.filters = [], this.selectedMutantStates = [], this.lines = [], this.mutants = [], Gl(this, $t, new AbortController());
  }
  connectedCallback() {
    super.connectedCallback(), window.addEventListener("keydown", je(this, Br), { signal: je(this, $t).signal });
  }
  disconnectedCallback() {
    je(this, $t).abort(), super.disconnectedCallback();
  }
  render() {
    const e = Map.groupBy(this.mutants, (r) => r.location.start.line), t = Z(this, q, Wr).call(this, Array.from(e.entries()).filter(([r]) => r > this.lines.length).flatMap(([, r]) => r));
    return g`<mte-state-filter
        allow-toggle-all
        .filters="${this.filters}"
        @filters-changed="${je(this, Rr)}"
        @next=${je(this, Nr)}
        @previous=${je(this, qr)}
      ></mte-state-filter>
      <pre
      ...
      >
        <code class="flex language-${this.model.language}">
          <table>${lt(this.lines, (r, a) => {
      const n = a + 1, i = Z(this, q, Wr).call(this, e.get(n));
      return Ri(r, Bi(i, this.lines.length === n ? t : G));
    })}</table>
          </code>
          </pre>`;
  }
  reactivate() {
    super.reactivate(), Z(this, q, Ur).call(this);
  }
  update(e) {
    e.has("model") && this.model && Z(this, q, Ur).call(this), (e.has("model") && this.model || e.has("selectedMutantStates")) && (this.mutants = this.model.mutants.filter((t) => this.selectedMutantStates.includes(t.status)).sort((t, r) => ir(t.location.start, r.location.start) ? 1 : -1), this.selectedMutant && !this.mutants.includes(this.selectedMutant) && e.has("selectedMutantStates") && // This extra check is to allow mutants that have been opened before, to stay open when a realtime update comes through
    Z(this, q, Gi).call(this, e.get("selectedMutantStates") ?? []) && Z(this, q, We).call(this, this.selectedMutant)), super.update(e);
  }
};
  ...
  return E(
    ...
    () => de(
      ...
      (t) => B`<svg
            ...
            >
              <title>${Qi(t)}</title>
              ${this.selectedMutant?.id === t.id ? Wi : Ui}
            </svg>`
    ),
    () => G
  );
...
We = function(e) {
  if (Z(this, q, Hi).call(this), Z(this, q, Kr).call(this, e), this.selectedMutant === e) {
    this.selectedMutant = void 0, this.dispatchEvent(fe("mutant-selected", { selected: !1, mutant: e }));
    return;
  } else this.selectedMutant && Z(this, q, Kr).call(this, this.selectedMutant);
  ...
  const r = Z(this, q, Yi).call(this, e), a = t.item(e.location.end.line - 1);
  a.insertAdjacentHTML("afterend", r), Ci(a), this.dispatchEvent(fe("mutant-selected", { selected: !0, mutant: e }));
};
Hi = function() {
  const e = this.code;
  e.querySelectorAll(`.${Vr}`).forEach((a) => a.classList.remove(Vr)), e.querySelectorAll(`.${Ji}`).forEach((a) => a.remove());
};
Ur = function() {
  ...
  this.lines = Oa(e, function* (a) {
    for (const n of t)
      ir(a, n.location.end) && (t.delete(n), yield { elementName: "span", id: n.id, isClosing: !0 });
    for (const n of r)
      ir(a, n.location.start) && (t.add(n), r.delete(n), yield {
        elementName: "span",
        id: n.id,
        attributes: {
          class: Cr(`mutant border-none ${n.status}`),
          title: Cr(Qi(n)),
          "data-mutant-id": Cr(n.id.toString())
        }
      });
  });
};
...
Yi = function(e) {
  const t = e.getMutatedLines().trimEnd(), r = e.getOriginalLines().trimEnd(), [a, n] = Wl(r, t), i = Oa(Fa(t, this.model.name), function* ({ offset: l }) {
  ...
  }), s = `<tr class="${Ji}"><td class="empty-line-number"></td><td class="line-marker"></td><td class="code">`, o = "</td></tr>";
  return i.map((l) => `${s}${l}${o}`).join("");
};
Kr = function(e) {
  Ki(this.code, "data-mutant-id", e.id);
};
Hl(ge, "styles", [vi, _e, Ie(Ul)]);
Re([
  re()
], ge.prototype, "filters", 2);
Re([
  C({ attribute: !1 })
], ge.prototype, "model", 2);
Re([
  re()
], ge.prototype, "selectedMutantStates", 2);
Re([
  re()
], ge.prototype, "selectedMutant", 2);
Re([
  re()
], ge.prototype, "lines", 2);
Re([
  re()
], ge.prototype, "mutants", 2);
Re([
  gt("code")
], ge.prototype, "code", 2);
ge = Re([
...
const Yl = (e, t, r) => {
  if (!e) return r?.all ? ec(t, r) : Yr;
  var a = Xl(e), n = a.bitflags, i = a.containsSpace, s = or(r?.threshold || 0), o = r?.limit || La, l = 0, u = 0, m = t.length;
  function _(T) {
    l < o ? (Vt.add(T), ++l) : (++u, T._score > Vt.peek()._score && Vt.replaceTop(T));
  }
  if (r?.key)
    for (var x = r.key, v = 0; v < m; ++v) {
      var $ = t[v], y = lr($, x);
      if (y && (st(y) || (y = it(y)), (n & y._bitflags) === n)) {
        var S = At(a, y);
        S !== K && (S._score < s || (S.obj = $, _(S)));
      }
    }
  else if (r?.keys) {
    var P = r.keys, p = P.length;
    e: for (var v = 0; v < m; ++v) {
      for (var $ = t[v], c = 0, f = 0; f < p; ++f) {
        ...
        st(y) || (y = it(y)), Mr[f] = y, c |= y._bitflags;
      }
      if ((n & c) === n) {
        if (i) for (let M = 0; M < a.spaceSearches.length; M++) we[M] = ie;
        for (var f = 0; f < p; ++f) {
          if (y = Mr[f], y === St) {
            rt[f] = St;
            continue;
          }
          if (rt[f] = At(a, y, !1, i), rt[f] === K) {
            rt[f] = St;
            continue;
          }
        ...
        if (i) {
          for (let M = 0; M < a.spaceSearches.length; M++) if (we[M] === ie) continue e;
        } else {
          var h = !1;
          for (let M = 0; M < p; M++) if (rt[M]._score !== ie) {
            h = !0;
            break;
          }
          if (!h) continue;
        ...
        var b = new es(p);
        for (let M = 0; M < p; M++) b[M] = rt[M];
        if (i) {
          var w = 0;
          for (let M = 0; M < a.spaceSearches.length; M++) w += we[M];
        } else {
          var w = ie;
          for (let A = 0; A < p; A++) {
            var S = b[A];
            if (S._score > -1e3 && w > ie) {
              var d = (w + S._score) / 4;
              d > w && (w = d);
            }
            S._score > w && (w = S._score);
          }
        }
        if (b.obj = $, b._score = w, r?.scoreFn) {
          if (w = r.scoreFn(b), !w) continue;
          w = or(w), b._score = w;
        }
        w < s || _(b);
      }
  ...
  if (l === 0) return Yr;
  for (var k = new Array(l), v = l - 1; v >= 0; --v) k[v] = Vt.poll();
...
var Xi = class {
  ...
  get score() {
    return rs(this._score);
  }
  set score(e) {
    this._score = or(e);
  }
}, es = class extends Array {
  get score() {
    return rs(this._score);
  }
  set score(e) {
...
const ts = (e, t) => {
...
}, rs = (e) => e === ie ? 0 : e > 1 ? e : Math.E ** (((-e + 1) ** 0.04307 - 1) * -2), or = (e) => e === 0 ? ie : e > 1 ? e : 1 - Math.pow(Math.log(e) / -2 + 1, 1 / 0.04307), An = (e) => {
  ...
  if (e.length > 999) return sr(e);
  var t = Hr.get(e);
  return t !== void 0 || (t = sr(e), Hr.set(e, t)), t;
}, Xl = (e) => {
  ...
  if (t?.key) for (var n = 0; n < e.length; n++) {
    ...
    for (var i = e[n], l = new es(t.keys.length), u = t.keys.length - 1; u >= 0; --u) {
      var s = lr(i, t.keys[u]);
      if (!s) {
        l[u] = St;
        continue;
      }
      st(s) || (s = it(s)), s._score = ie, s._indexes.len = 0, l[u] = s;
    }
    if (l.obj = i, l._score = ie, r.push(l), r.length >= a) return r;
  }
  else for (var n = 0; n < e.length; n++) {
    var s = e[n];
    if (s != K && (st(s) || (s = it(s)), s._score = ie, s._indexes.len = 0, r.push(s), r.length >= a))
      return r;
  }
  return r;
}, At = (e, t, r = !1, a = !1) => {
  if (r === !1 && e.containsSpace) return tc(e, t, a);
  for (var n = e._lower, i = e.lowerCodes, s = i[0], o = t._targetLowerCodes, l = i.length, u = o.length, v = 0, m = 0, _ = 0; ; ) {
    var x = s === o[m];
    if (x) {
      if (ye[_++] = m, ++v, v === l) break;
      s = i[v];
    }
    if (++m, m >= u) return K;
  }
  var v = 0, $ = !1, y = 0, S = t._nextBeginningIndexes;
  S === K && (S = t._nextBeginningIndexes = ac(t.target)), m = ye[0] === 0 ? 0 : S[ye[0] - 1];
  var P = 0;
  if (m !== u) for (; ; ) if (m >= u) {
    if (v <= 0 || (++P, P > 200)) break;
    --v;
    var p = Ut[--y];
    m = S[p];
  } else {
  ...
  var c = l <= 1 ? -1 : t._targetLower.indexOf(n, ye[0]), f = !!~c, d = f ? c === 0 || t._nextBeginningIndexes[c - 1] === c : !1;
  if (f && !d) {
  ...
  var w = (M) => {
    ...
    var tt = M[l - 1] - M[0] - (l - 1);
    if (A -= (12 + tt) * Me, M[0] !== 0 && (A -= M[0] * M[0] * 0.2), !$) A *= 1e3;
    else {
      for (var me = 1, J = S[0]; J < u; J = S[J]) ++me;
      me > 24 && (A *= (me - 24) * 10);
    }
  ...
  if ($)
    if (d) {
      for (var h = 0; h < l; ++h) ye[h] = c + h;
      var k = ye, T = w(ye);
    } else
      var k = Ut, T = w(Ut);
  else {
    if (f) for (var h = 0; h < l; ++h) ye[h] = c + h;
    var k = ye, T = w(k);
  }
  t._score = T;
  ...
  for (var a = /* @__PURE__ */ new Set(), n = 0, i = K, s = 0, o = e.spaceSearches, l = o.length, u = 0, m = () => {
    for (let f = u - 1; f >= 0; f--) t._nextBeginningIndexes[Kt[f * 2 + 0]] = Kt[f * 2 + 1];
  }, _ = !1, c = 0; c < l; ++c) {
    Ve[c] = ie;
    var x = o[c];
    if (i = At(x, t), r) {
    ...
    if (c !== l - 1) {
      ...
      if ($) {
        var y = v[v.len - 1] + 1, S = t._nextBeginningIndexes[y - 1];
        for (let d = y - 1; d >= 0 && S === t._nextBeginningIndexes[d]; d--)
          t._nextBeginningIndexes[d] = y, Kt[u * 2 + 0] = d, Kt[u * 2 + 1] = S, u++;
      }
    }
    n += i._score / l, Ve[c] = i._score / l, i._indexes[0] < s && (n -= (s - i._indexes[0]) * 2), s = i._indexes[0];
    for (var P = 0; P < i._indexes.len; ++P) a.add(i._indexes[P]);
  }
  if (r && !_) return K;
  m();
  var p = At(e, t, !0);
  if (p !== K && p._score > n) {
    if (r) for (var c = 0; c < l; ++c) Ve[c] = p._score / l;
    return p;
  }
  r && (i = t), i._score = n;
  var c = 0;
...
}, as = (e) => e.replace(new RegExp("\\p{Script=Latin}+", "gu"), (t) => t.normalize("NFD")).replace(/[\u0300-\u036f]/g, ""), Zr = (e) => {
  e = as(e);
  ...
  e = as(e);
  for (var t = e.length, r = rc(e), a = [], n = r[0], i = 0, s = 0; s < t; ++s) n > s ? a[s] = n : (n = r[++i], a[s] = n === void 0 ? t : n);
  return a;
}, Hr = /* @__PURE__ */ new Map(), Gr = /* @__PURE__ */ new Map();
var ye = [], Ut = [], Kt = [], we = [], Ve = [], Mr = [], rt = [];
const lr = (e, t) => {
  var r = e[t];
  ...
  return e;
}, st = (e) => typeof e == "object" && typeof e._bitflags == "number", La = 1 / 0, ie = -La, Yr = [];
Yr.total = 0;
const K = null, St = sr(""), nc = (e) => {
  var t = [], r = 0, a = {}, n = (i) => {
...
}, Vt = nc(), ic = B`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" aria-label="directory" class="octicon octicon-file-directory"><path d="M1.75 1A1.75 1.75 0 0 0 0 2.75v10.5C0 14.216.784 15 1.75 15h12.5A1.75 1.75 0 0 0 16 13.25v-8.5A1.75 1.75 0 0 0 14.25 3H7.5a.25.25 0 0 1-.2-.1l-.9-1.2C6.07 1.26 5.55 1 5 1z"/></svg>`, sc = B`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" aria-label="file" class="octicon octicon-file"><path d="M2 1.75C2 .784 2.784 0 3.75 0h6.586c.464 0 .909.184 1.237.513l2.914 2.914c.329.328.513.773.513 1.237v9.586A1.75 1.75 0 0 1 13.25 16h-9.5A1.75 1.75 0 0 1 2 14.25Zm1.75-.25a.25.25 0 0 0-.25.25v12.5c0 .138.112.25.25.25h9.5a.25.25 0 0 0 .25-.25V6h-2.75A1.75 1.75 0 0 1 9 4.25V1.5Zm6.75.062V4.25c0 .138.112.25.25.25h2.688l-.011-.013-2.914-2.914z"/></svg>`, ns = B`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor"><path d="M10.25 2a8.25 8.25 0 0 1 6.34 13.53l5.69 5.69a.749.749 0 0 1-.326 1.275.75.75 0 0 1-.734-.215l-5.69-5.69A8.25 8.25 0 1 1 10.25 2M3.5 10.25a6.75 6.75 0 1 0 13.5 0 6.75 6.75 0 0 0-13.5 0"/></svg>`, oc = B`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"><path d="M4 1.75C4 .784 4.784 0 5.75 0h5.586c.464 0 .909.184 1.237.513l2.914 2.914c.329.328.513.773.513 1.237v8.586A1.75 1.75 0 0 1 14.25 15h-9a.75.75 0 0 1 0-1.5h9a.25.25 0 0 0 .25-.25V6h-2.75A1.75 1.75 0 0 1 10 4.25V1.5H5.75a.25.25 0 0 0-.25.25v2.5a.75.75 0 0 1-1.5 0Zm1.72 4.97a.75.75 0 0 1 1.06 0l2 2a.75.75 0 0 1 0 1.06l-2 2a.749.749 0 0 1-1.275-.326.75.75 0 0 1 .215-.734l1.47-1.47-1.47-1.47a.75.75 0 0 1 0-1.06M3.28 7.78 1.81 9.25l1.47 1.47a.75.75 0 0 1-.018 1.042.75.75 0 0 1-1.042.018l-2-2a.75.75 0 0 1 0-1.06l2-2a.75.75 0 0 1 1.042.018.75.75 0 0 1 .018 1.042m8.22-6.218V4.25c0 .138.112.25.25.25h2.688l-.011-.013-2.914-2.914z"/></svg>`, lc = B`<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"><path d="M10.336 0c.464 0 .91.184 1.237.513l2.914 2.914c.33.328.513.773.513 1.237v3.587c0 .199-.079.39-.22.53a.747.747 0 0 1-1.06 0 .75.75 0 0 1-.22-.53V6h-2.75c-.464 0-.909-.184-1.237-.513A1.75 1.75 0 0 1 9 4.25V1.5H3.75a.25.25 0 0 0-.25.25v12.5c0 .138.112.25.25.25H7c.199 0 .39.079.53.22a.747.747 0 0 1 0 1.06A.75.75 0 0 1 7 16H3.75c-.464 0-.909-.184-1.237-.513A1.75 1.75 0 0 1 2 14.25V1.75C2 .784 2.784 0 3.75 0Zm.164 4.25c0 .138.112.25.25.25h2.688l-.011-.013-2.914-2.914-.013-.011Z"/><path d="M15.259 10a.75.75 0 0 1 .686.472.75.75 0 0 1-.171.815l-4.557 4.45a.75.75 0 0 1-1.055-.01L8.22 13.778a.754.754 0 0 1 .04-1.02.75.75 0 0 1 1.02-.038l1.42 1.425 4.025-3.932a.75.75 0 0 1 .534-.213"/></svg>`, is = (e) => B`<svg xmlns="http://www.w3.org/2000/svg" fill="#fff" aria-hidden="true" class="${e} h-4 w-4" viewBox="0 0 16 16"><path d="M8.22 2.97a.75.75 0 0 1 1.06 0l4.25 4.25a.75.75 0 0 1 0 1.06l-4.25 4.25a.75.75 0 0 1-1.042-.018.75.75 0 0 1-.018-1.042l2.97-2.97H3.75a.75.75 0 0 1 0-1.5h7.44L8.22 4.03a.75.75 0 0 1 0-1.06"/></svg>`, cc = is("rotate-180"), uc = is();
var ss = Object.defineProperty, dc = Object.getOwnPropertyDescriptor, os = (e) => {
  throw TypeError(e);
}, hc = (e, t, r) => t in e ? ss(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, Xe = (e, t, r, a) => {
  for (var n = a > 1 ? void 0 : a ? dc(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (n = (a ? s(t, r, n) : s(n)) || n);
  return a && n && ss(t, r, n), n;
}, Tn = (e, t, r) => hc(e, typeof t != "symbol" ? t + "" : t, r), Da = (e, t, r) => t.has(e) || os("Cannot " + r), pe = (e, t, r) => (Da(e, t, "read from private field"), t.get(e)), Te = (e, t, r) => t.has(e) ? os("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), ls = (e, t, r, a) => (Da(e, t, "write to private field"), t.set(e, r), r), le = (e, t, r) => (Da(e, t, "access private method"), r), Jt, dt, Qt, ee, cs, us, ds, Jr, hs, ps, fs, gs, Qr, Xr, ea, Xt, Ba;
let Oe = class extends Be {
  constructor() {
    super(), Te(this, ee), Te(this, Jt, new AbortController()), Te(this, dt, []), Te(this, Qt, ""), Tn(this, "open", () => {
      this.dialog.showModal();
    }), Tn(this, "close", () => {
      this.dialog.close();
    }), Te(this, Jr, (e) => {
      ((e.ctrlKey || e.metaKey) && e.key === "k" || !this.isOpen && e.key === "/") && pe(this, Qr).call(this, e), this.isOpen && (e.key === "ArrowUp" ? le(this, ee, fs).call(this) : e.key === "ArrowDown" && le(this, ee, ps).call(this), e.key === "Enter" && le(this, ee, gs).call(this));
    }), Te(this, Qr, (e = null) => {
      e?.preventDefault(), e?.stopPropagation(), this.isOpen ? this.close() : this.open();
    }), Te(this, Xr, (e) => {
      e.newState === "closed" ? (le(this, ee, Xt).call(this, ""), this.filePickerInput.value = "", document.body.style.overflow = pe(this, Qt)) : e.newState === "open" ? document.body.style.overflow = "hidden" : console.warn("Unknown toggle state in file-picker:", e.newState);
    }), Te(this, ea, (e) => {
      this.isOpen && le(this, ee, Xt).call(this, e.target.value);
  ...
  connectedCallback() {
    super.connectedCallback(), ls(this, Qt, document.body.style.overflow), window.addEventListener("keydown", pe(this, Jr), { signal: pe(this, Jt).signal });
  }
  disconnectedCallback() {
    super.disconnectedCallback(), Ql(), pe(this, Jt).abort();
  }
  willUpdate(e) {
    e.has("rootModel") && (le(this, ee, ds).call(this), le(this, ee, Xt).call(this, ""));
  }
  updated(e) {
    (e.has("fileIndex") || e.has("filteredFiles")) && le(this, ee, hs).call(this);
  }
  render() {
    return g`<dialog
      @click="${this.close}"
    ...
    >
      <div @click="${(e) => e.stopPropagation()}" class="flex h-fit max-h-132 flex-col rounded-lg bg-gray-200/60 p-4 backdrop-blur-lg">
        <div class="mb-3 flex items-center rounded-sm bg-gray-200/60 p-2 text-gray-800 shadow-lg">
          <div class="mx-2 flex items-center">${ns}</div>
      ...
      return g`<li
              ...
              >
                <a
                  ...
                  href="${bt(n, e)}"
                >
                  <span class="inline-flex" title="File with ${n}s">${le(this, ee, us).call(this, n)}</span>
  ...
  const e = (t, r = null, a) => {
    if (t) {
      if (t.file && t.name !== a) {
        ...
        pe(this, dt).push({ name: n, file: t.file, prepared: sr(n) });
      }
...
gs = function() {
  ...
  window.location.href = bt(le(this, ee, Ba).call(this, e.file), e.name), this.close();
};
Qr = /* @__PURE__ */ new WeakMap();
Xr = /* @__PURE__ */ new WeakMap();
ea = /* @__PURE__ */ new WeakMap();
Xt = function(e) {
  e ? this.filteredFiles = Yl(e, pe(this, dt), { key: "prepared", threshold: 0.3, limit: 500 }).map((t) => ({
    file: t.obj.file,
    name: t.obj.name,
  ...
  })) : this.filteredFiles = pe(this, dt), this.fileIndex = 0;
};
Ba = function(e) {
...
Xe([
  C({ attribute: !1 })
], Oe.prototype, "rootModel", 2);
Xe([
  re()
], Oe.prototype, "filteredFiles", 2);
Xe([
  re()
], Oe.prototype, "fileIndex", 2);
Xe([
  gt("dialog", !0)
], Oe.prototype, "dialog", 2);
Xe([
  gt("#file-picker-input", !0)
], Oe.prototype, "filePickerInput", 2);
Xe([
  gt('[aria-selected="true"] a')
], Oe.prototype, "activeLink", 2);
Oe = Xe([
  V("mte-file-picker")
], Oe);
var pc = Object.defineProperty, fc = Object.getOwnPropertyDescriptor, ms = (e) => {
  throw TypeError(e);
}, Ra = (e, t, r, a) => {
  for (var n = a > 1 ? void 0 : a ? fc(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (n = (a ? s(t, r, n) : s(n)) || n);
  return a && n && pc(t, r, n), n;
}, gc = (e, t, r) => t.has(e) || ms("Cannot " + r), mc = (e, t, r) => t.has(e) ? ms("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), Ze = (e, t, r) => (gc(e, t, "access private method"), r), xe, vs, ja, Na, bs, ys;
let cr = class extends Be {
  constructor() {
    super(...arguments), mc(this, xe);
  }
  get rootName() {
    switch (this.view) {
      case ce.mutant:
  ...
  render() {
    return g`<nav class="my-4 flex rounded-md bg-primary-100 p-3 text-gray-700" aria-label="Breadcrumb">
      <ol class="inline-flex items-center">
        ${this.path && this.path.length > 0 ? Ze(this, xe, Na).call(this, this.rootName, []) : Ze(this, xe, ja).call(this, this.rootName)}
        ${Ze(this, xe, vs).call(this)}
      </ol>
      ${Ze(this, xe, bs).call(this)}
    </nav>`;
  }
};
...
vs = function() {
  if (this.path) {
    ...
    return de(
      e,
      (t) => t,
      (t, r) => r === e.length - 1 ? Ze(this, xe, ja).call(this, t) : Ze(this, xe, Na).call(this, t, e.slice(0, r + 1))
    );
  }
};
ja = function(e) {
...
bs = function() {
  return g`<button @click="${() => Ze(this, xe, ys).call(this)}" class="ml-auto cursor-pointer" title="Open file picker (Ctrl-K)"
      >${ns}</button
    >`;
};
ys = function() {
  this.blur(), this.renderRoot.querySelector("button")?.blur(), this.dispatchEvent(fe("mte-file-picker-open", void 0));
};
Ra([
...
var vc = Object.defineProperty, bc = Object.getOwnPropertyDescriptor, ws = (e) => {
  throw TypeError(e);
}, ks = (e, t, r, a) => {
  for (var n = a > 1 ? void 0 : a ? bc(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (n = (a ? s(t, r, n) : s(n)) || n);
  return a && n && vc(t, r, n), n;
}, xs = (e, t, r) => t.has(e) || ws("Cannot " + r), En = (e, t, r) => (xs(e, t, "read from private field"), r ? r.call(e) : t.get(e)), Ar = (e, t, r) => t.has(e) ? ws("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), at = (e, t, r) => (xs(e, t, "access private method"), r), Pe, _s, qa, ta, ra, aa, $s;
let na = class extends Ce {
  constructor() {
    super(...arguments), Ar(this, Pe), Ar(this, ta, (e) => {
      e.stopPropagation(), this.dispatchEvent(fe("next", void 0, { bubbles: !0, composed: !0 }));
    }), Ar(this, ra, (e) => {
      e.stopPropagation(), this.dispatchEvent(fe("previous", void 0, { bubbles: !0, composed: !0 }));
    });
  }
  updated(e) {
    e.has("filters") && at(this, Pe, qa).call(this);
  }
  render() {
    return g`<div class="sticky top-offset z-10 mb-1 flex flex-row gap-5 bg-white py-6 pt-7">
      <div class="flex items-center gap-2">
        ${at(this, Pe, aa).call(this, En(this, ra), cc, "Previous", "Select previous mutant")}
        ${at(this, Pe, aa).call(this, En(this, ta), uc, "Next", "Select next mutant")}
      </div>
      ...
      (e) => g`<div class="flex items-center gap-2 last:mr-12" data-status="${e.status.toString()}">
            <input
              ...
              @input="${(t) => at(this, Pe, _s).call(this, e, t.target.checked)}"
            ...
            <label
              for="filter-${e.status}"
              class="${at(this, Pe, $s).call(this, e.context)} rounded-md px-2.5 py-0.5 text-sm font-medium hover:cursor-pointer"
            >
              ${e.label} (${e.count})
            </label>
          </div>`
...
_s = function(e, t) {
  e.enabled = t, at(this, Pe, qa).call(this);
};
qa = function() {
  this.dispatchEvent(
    fe(
...
var Cc = Object.defineProperty, Mc = Object.getOwnPropertyDescriptor, Ts = (e) => {
  throw TypeError(e);
}, Wa = (e, t, r, a) => {
  for (var n = a > 1 ? void 0 : a ? Mc(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (n = (a ? s(t, r, n) : s(n)) || n);
  return a && n && Cc(t, r, n), n;
}, Ac = (e, t, r) => t.has(e) || Ts("Cannot " + r), Tc = (e, t, r) => t.has(e) ? Ts("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), Pn = (e, t, r) => (Ac(e, t, "access private method"), r), er, Es, Ps;
const zn = (e) => `${e.name}${e.sourceFile && e.location ? ` (${Si(e)})` : ""}`, Fn = (e) => g`<span class="whitespace-pre-wrap">${e}</span>`;
let dr = class extends Ce {
  constructor() {
    super(), Tc(this, er), this.mode = "closed";
  }
  render() {
    return As(
      ...
      E(
        ...
        (e) => g`<span class="align-middle text-lg" slot="header"
            ...
            >
            <span slot="summary">${Pn(this, er, Es).call(this)}</span>
            <span slot="detail" class="block">${Pn(this, er, Ps).call(this)}</span>`
      )
    );
  }
};
...
Es = function() {
  return bi(
    g`${E(
      ...
      (e) => Ue(
        g`${I("🎯", "killed")} Killed by:
          ${e.name}${this.mutant.killedByTests.length > 1 ? `(and ${this.mutant.killedByTests.length - 1} more)` : ""}`
      )
    )}
      ${E(this.mutant?.static, () => Ue(g`${I("🗿", "static")} Static mutant`))}
      ${E(
      this.mutant?.coveredByTests,
      (e) => Ue(
        g`${I("☂️", "umbrella")} Covered by ${e.length}
          test${$i(e)}${this.mutant?.status === "Survived" ? " (yet still survived)" : ""}`
      )
    )}
      ${E(
      this.mutant?.statusReason?.trim(),
      (e) => Ue(g`${I("🕵️", "spy")} ${Fn(e)}`, `Reason for the ${this.mutant.status} status`)
    )}
      ${E(this.mutant?.description, (e) => Ue(g`${I("📖", "book")} ${Fn(e)}`))}`
  );
};
Ps = function() {
  return g`<ul class="mr-2 mb-6">
    ...
    (e) => nr("This mutant was killed by this test", g`${I("🎯", "killed")} ${zn(e)}`)
  )}
      ${lt(
    this.mutant?.coveredByTests?.filter((e) => !this.mutant?.killedByTests?.includes(e)),
    (e) => nr("This mutant was covered by this test", g`${I("☂️", "umbrella")} ${zn(e)}`)
  )}
    </ul>`;
};
Wa([
  C({ attribute: !1 })
], dr.prototype, "mutant", 2);
Wa([
  C({ reflect: !0 })
], dr.prototype, "mode", 2);
dr = Wa([
...
var Ec = Object.defineProperty, Pc = Object.getOwnPropertyDescriptor, zs = (e) => {
  throw TypeError(e);
}, yt = (e, t, r, a) => {
  for (var n = a > 1 ? void 0 : a ? Pc(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (n = (a ? s(t, r, n) : s(n)) || n);
  return a && n && Ec(t, r, n), n;
}, zc = (e, t, r) => t.has(e) || zs("Cannot " + r), On = (e, t, r) => (zc(e, t, "read from private field"), r ? r.call(e) : t.get(e)), In = (e, t, r) => t.has(e) ? zs("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), sa, oa;
let Je = class extends Ce {
  ...
  render() {
    return g`<main class="pb-drawer-half-open" @click="${On(this, sa)}">
        <mte-metrics-table .columns="${Fc}" .currentPath="${this.path}" .thresholds="${this.thresholds}" .model="${this.result}">
        </mte-metrics-table>
        ${E(this.result.file, (e) => g`<mte-file @mutant-selected="${On(this, oa)}" .model="${e}"></mte-file>`)}
      </main>
...
yt([
  re()
], Je.prototype, "drawerMode", 2);
yt([
  C({ attribute: !1 })
], Je.prototype, "selectedMutant", 2);
yt([
  C({ attribute: !1 })
], Je.prototype, "result", 2);
yt([
  C({ attribute: !1, reflect: !1 })
], Je.prototype, "thresholds", 2);
yt([
  C({ attribute: !1, reflect: !1 })
], Je.prototype, "path", 2);
Je = yt([
...
}, Lc = (e, t, r) => t.has(e) || Fs("Cannot " + r), Ln = (e, t, r) => (Lc(e, t, "read from private field"), r ? r.call(e) : t.get(e)), Dn = (e, t, r) => t.has(e) ? Fs("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), la, ca;
let ht = class extends Ce {
  ...
  render() {
    return g`<main class="pb-drawer-half-open" @click="${Ln(this, la)}">
        <mte-metrics-table .columns="${Dc}" .currentPath="${this.path}" .model="${this.result}"> </mte-metrics-table>
        ${E(this.result.file, (e) => g`<mte-test-file @test-selected="${Ln(this, ca)}" .model="${e}"></mte-test-file>`)}
      </main>
...
Lt([
  re()
], ht.prototype, "drawerMode", 2);
Lt([
  C({ attribute: !1 })
], ht.prototype, "result", 2);
Lt([
  C({ attribute: !1, reflect: !1 })
], ht.prototype, "path", 2);
Lt([
  C({ attribute: !1 })
], ht.prototype, "selectedTest", 2);
ht = Lt([
  V("mte-test-view")
], ht);
const Dc = [
...
}, Ua = (e, t, r) => t.has(e) || Os("Cannot " + r), jc = (e, t, r) => (Ua(e, t, "read from private field"), t.get(e)), Bn = (e, t, r) => t.has(e) ? Os("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), Nc = (e, t, r, a) => (Ua(e, t, "write to private field"), t.set(e, r), r), $e = (e, t, r) => (Ua(e, t, "access private method"), r), hr, ue, Is, ua, Ls, da, Ds, Bs, Rs;
let pt = class extends Ce {
  constructor() {
    super(), Bn(this, ue), Bn(this, hr, !1), this.currentPath = [], this.thresholds = {
      high: 80,
      low: 60
    };
  }
  willUpdate(e) {
    e.has("columns") && Nc(this, hr, this.columns.some((t) => t.category === "percentage"));
  }
  render() {
    return E(
      this.model,
      (e) => g`<div class="overflow-x-auto rounded-md border border-gray-200">
          <table class="w-full table-auto text-left text-sm">${$e(this, ue, Is).call(this)}${$e(this, ue, Ls).call(this, e)} </table>
        </div>`
    );
  }
};
  ...
  return g`<tr title="${t.name}" class="group hover:bg-gray-200">
      <td class="font-semibold">
        <div class="flex items-center justify-start">
          <mte-file-icon file-name="${t.name}" ?file="${t.file}" class="mx-1 flex items-center"></mte-file-icon> ${r.length > 0 ? g`<a class="mr-auto inline-block w-full py-4 pr-2 hover:text-primary-on hover:underline" href="${bt(...r)}"
                >${e}</a
              >` : g`<span class="py-4">${t.name}</span>`}
        </div>
      </td>
      ${de(
    this.columns,
    (a) => a.key,
    (a) => $e(this, ue, Ds).call(this, a, t.metrics)
  )}
    </tr>`;
};
Ds = function(e, t) {
  const r = t[e.key], a = jc(this, hr) ? "odd:bg-gray-100" : "even:bg-gray-100";
  if (e.category === "percentage") {
    const n = !isNaN(r), i = $e(this, ue, Bs).call(this, r), s = $e(this, ue, Rs).call(this, r), o = r.toFixed(2), l = `width: ${r}%`;
    return g`<td class="bg-gray-100 px-4 py-4 group-hover:bg-gray-200!">
        ...
        <td class="${s} ${a} w-12 pr-2 text-center font-bold group-hover:bg-gray-200!"
          >${E(n, () => g`<span class="transition-colors">${o}</span>`)}</td
        >`;
  }
  return g`<td
...
Dt([
  C({ attribute: !1 })
], pt.prototype, "currentPath", 2);
Dt([
  C({ type: Array })
], pt.prototype, "columns", 2);
Dt([
  C({ attribute: !1 })
], pt.prototype, "thresholds", 2);
pt = Dt([
  V("mte-metrics-table")
], pt);
const qc = '#report-code-block{background:var(--prism-background);border:1px solid var(--prism-border);overflow:auto visible}.line-numbers{counter-reset:mte-line-number}.line .line-number{text-align:right;color:var(--mut-line-number);counter-increment:mte-line-number;padding:0 10px 0 15px}.line .line-number:before{content:counter(mte-line-number)}.line-marker:before{content:" ";padding:0 5px}.Killing{--mut-test-dot-color:var(--color-green-700)}.Covering{--mut-test-dot-color:var(--color-amber-400)}.NotCovering{--mut-test-dot-color:var(--color-orange-500)}svg.test-dot{fill:var(--mut-test-dot-color)}';
var js = Object.defineProperty, Wc = Object.getOwnPropertyDescriptor, Ns = (e) => {
  throw TypeError(e);
}, Uc = (e, t, r) => t in e ? js(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, et = (e, t, r, a) => {
  for (var n = a > 1 ? void 0 : a ? Wc(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (n = (a ? s(t, r, n) : s(n)) || n);
  return a && n && js(t, r, n), n;
}, Kc = (e, t, r) => Uc(e, t + "", r), Ka = (e, t, r) => t.has(e) || Ns("Cannot " + r), Ee = (e, t, r) => (Ka(e, t, "read from private field"), t.get(e)), qe = (e, t, r) => t.has(e) ? Ns("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), Vc = (e, t, r, a) => (Ka(e, t, "write to private field"), t.set(e, r), r), H = (e, t, r) => (Ka(e, t, "access private method"), r), Ct, ha, pa, W, ft, fa, ga, ma, qs, Ws, pr, va, ba, ya;
let Se = class extends Ce {
  constructor() {
    super(), qe(this, W), qe(this, Ct), qe(this, ha, (e) => {
      e.key === "Escape" && Ee(this, pr).call(this);
    }), qe(this, pa, (e) => {
      this.enabledStates = e.detail, this.selectedTest && !this.enabledStates.includes(this.selectedTest.status) && H(this, W, ft).call(this, this.selectedTest);
    }), qe(this, fa, () => {
      const e = this.selectedTest ? (this.tests.findIndex(({ id: t }) => t === this.selectedTest.id) + 1) % this.tests.length : 0;
      H(this, W, ma).call(this, this.tests[e]);
    }), qe(this, ga, () => {
      ...
      this.selectedTest && H(this, W, ft).call(this, this.selectedTest);
    }), this.filters = [], this.lines = [], this.enabledStates = [], this.tests = [], Vc(this, Ct, new AbortController());
  }
  connectedCallback() {
    super.connectedCallback(), window.addEventListener("keydown", Ee(this, ha), { signal: Ee(this, Ct).signal });
  }
  disconnectedCallback() {
    Ee(this, Ct).abort(), super.disconnectedCallback();
  }
  render() {
    return g`<mte-state-filter
        @next=${Ee(this, fa)}
      ...
      ></mte-state-filter>
      ${H(this, W, qs).call(this)} ${H(this, W, Ws).call(this)}`;
  }
  reactivate() {
    super.reactivate(), H(this, W, ba).call(this);
  }
  willUpdate(e) {
    e.has("model") && H(this, W, ba).call(this), (e.has("model") || e.has("enabledStates")) && this.model && (this.tests = this.model.tests.filter((t) => this.enabledStates.includes(t.status)).sort((t, r) => t.location && r.location ? ir(t.location.start, r.location.start) ? 1 : -1 : this.model.tests.indexOf(t) - this.model.tests.indexOf(r)));
  }
};
...
ft = function(e) {
  H(this, W, ya).call(this, e), this.selectedTest === e ? (this.selectedTest = void 0, this.dispatchEvent(fe("test-selected", { selected: !1, test: e }))) : (this.selectedTest && H(this, W, ya).call(this, this.selectedTest), this.selectedTest = e, this.dispatchEvent(fe("test-selected", { selected: !0, test: e })), Ci(this.renderRoot.querySelector(`[data-test-id="${e.id}"]`)));
};
fa = /* @__PURE__ */ new WeakMap();
ga = /* @__PURE__ */ new WeakMap();
ma = function(e) {
  e && H(this, W, ft).call(this, e);
};
qs = function() {
    ...
    () => g`<ul class="max-w-6xl">
      ...
      (t) => g`<li class="my-3">
                <button
                  ...
                  data-test-id="${t.id}"
                  @click=${(r) => {
        r.stopPropagation(), H(this, W, ft).call(this, t);
      }}
...
Ws = function() {
  return E(
    ...
    () => {
      const e = Map.groupBy(
        this.tests.filter((r) => co(r.location)),
        (r) => r.location.start.line
      ), t = H(this, W, va).call(this, Array.from(e.entries()).filter(([r]) => r > this.lines.length).flatMap(([, r]) => r));
      return g`<pre
          id="report-code-block"
          @click="${Ee(this, pr)}"
      ...
      <table>
        ${lt(this.lines, (r, a) => {
        const n = a + 1, i = H(this, W, va).call(this, e.get(n));
        return Ri(r, Bi(i, this.lines.length === n ? t : G));
      })}</table></code></pre>`;
    },
    () => G
...
ya = function(e) {
  Ki(this.renderRoot, "data-test-id", e.id);
};
Kc(Se, "styles", [vi, _e, Ie(qc)]);
et([
  C({ attribute: !1 })
...
var Hc = Object.defineProperty, Gc = Object.getOwnPropertyDescriptor, Us = (e) => {
  throw TypeError(e);
}, Va = (e, t, r, a) => {
  for (var n = a > 1 ? void 0 : a ? Gc(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (n = (a ? s(t, r, n) : s(n)) || n);
  return a && n && Hc(t, r, n), n;
}, Yc = (e, t, r) => t.has(e) || Us("Cannot " + r), Jc = (e, t, r) => t.has(e) ? Us("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), Rn = (e, t, r) => (Yc(e, t, "access private method"), r), tr, Ks, Vs;
const wa = (e) => g`<code>${e.getMutatedLines()}</code> (${Si(e)})`;
let fr = class extends Ce {
  constructor() {
    super(), Jc(this, tr), this.mode = "closed";
  }
  render() {
    return As(
      // eslint-disable-next-line @typescript-eslint/prefer-nullish-coalescing -- we want to coalesce on length 0
      ...
      E(
        ...
        (e) => g`<span class="align-middle text-lg" slot="header"
              ...
              ${E(e.location, (t) => g`(${t.start.line}:${t.start.column})`)}</span
            >
            <span slot="summary">${Rn(this, tr, Ks).call(this)}</span>
            <span class="block" slot="detail">${Rn(this, tr, Vs).call(this)}</span>`
      )
    );
  }
};
...
Ks = function() {
  return bi(
    g`${E(
      ...
      (e) => Ue(
        g`${I("🎯", "killed")} Killed:
          ${wa(e)}${this.test.killedMutants.length > 1 ? g` (and ${this.test.killedMutants.length - 1} more)` : ""}`
      )
    )}
      ${E(
      this.test?.coveredMutants,
      (e) => Ue(
        g`${I("☂️", "umbrella")} Covered ${e.length}
...
Vs = function() {
  return g`<ul class="mr-2 mb-6">
    ...
    (e) => nr("This test killed this mutant", g`${I("🎯", "killed")} ${wa(e)}`)
  )}
      ${lt(
    this.test?.coveredMutants?.filter((e) => !this.test?.killedMutants?.includes(e)),
    (e) => nr("This test covered this mutant", g`${I("☂️", "umbrella")} ${wa(e)}`)
  )}
    </ul>`;
};
Va([
...
ne = function() {
  return xa({ [U(this, j, gr)?.toString() ?? "unknown"]: this.file, test: U(this, j, Gs) });
};
tu(Ft, "styles", [Ie(Qc)]);
Za([
  C({ attribute: "file-name" })
], Ft.prototype, "fileName", 2);
Za([
  C({ type: Boolean })
], Ft.prototype, "file", 2);
Ft = Za([
...
var nu = Object.defineProperty, iu = Object.getOwnPropertyDescriptor, Ys = (e, t, r, a) => {
  for (var n = a > 1 ? void 0 : a ? iu(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (n = (a ? s(t, r, n) : s(n)) || n);
  return a && n && nu(t, r, n), n;
};
let ka = class extends Be {
  render() {
...
var ou = Object.defineProperty, lu = Object.getOwnPropertyDescriptor, Js = (e) => {
  throw TypeError(e);
}, wt = (e, t, r, a) => {
  for (var n = a > 1 ? void 0 : a ? lu(t, r) : t, i = e.length - 1, s; i >= 0; i--)
    (s = e[i]) && (n = (a ? s(t, r, n) : s(n)) || n);
  return a && n && ou(t, r, n), n;
}, Ha = (e, t, r) => t.has(e) || Js("Cannot " + r), cu = (e, t, r) => (Ha(e, t, "read from private field"), r ? r.call(e) : t.get(e)), jn = (e, t, r) => t.has(e) ? Js("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), uu = (e, t, r, a) => (Ha(e, t, "write to private field"), t.set(e, r), r), ot = (e, t, r) => (Ha(e, t, "access private method"), r), mr, Fe, Qs, Ga, Xs, eo, to;
let Qe = class extends Be {
  constructor() {
    super(), jn(this, Fe), jn(this, mr), this.detected = 0, this.noCoverage = 0, this.pending = 0, this.survived = 0, this.total = 0, uu(this, mr, new su(this, {
      callback: ([e]) => !e.isIntersecting
    }));
  }
  render() {
    return g`${ot(this, Fe, Qs).call(this)}
      <div data-test-id="progress-bar" class="my-4 rounded-md bg-white transition-all">
        <div class="parts flex h-8 w-full overflow-hidden rounded-sm bg-gray-200">${ot(this, Fe, Ga).call(this, !1)}</div>
      </div>`;
  }
};
...
Qs = function() {
  return g`<div
      ...
      class="${cu(this, mr).value ? "opacity-100" : "opacity-0"} pointer-events-none fixed top-offset left-0 z-20 flex w-full justify-center transition-all"
    >
      <div class="container w-full bg-white py-2">
        <div class="flex h-2 overflow-hidden rounded-sm bg-gray-200">${ot(this, Fe, Ga).call(this, !0)}</div>
      </div>
    </div>`;
};
Ga = function(e) {
  return de(
    ot(this, Fe, Xs).call(this),
    (t) => t.type,
    (t) => g`<div
          title="${e ? G : t.tooltip}"
          style="width: ${ot(this, Fe, to).call(this, t.amount)}%"
          class="${ot(this, Fe, eo).call(this, t.type)} ${t.amount === 0 ? "opacity-0" : "opacity-100"} relative flex items-center overflow-hidden motion-safe:transition-width"
...
wt([
  C({ type: Number })
], Qe.prototype, "detected", 2);
wt([
  C({ type: Number, attribute: "no-coverage" })
], Qe.prototype, "noCoverage", 2);
wt([
  C({ type: Number })
], Qe.prototype, "pending", 2);
wt([
  C({ type: Number })
], Qe.prototype, "survived", 2);
wt([
  C({ type: Number })
], Qe.prototype, "total", 2);
Qe = wt([
