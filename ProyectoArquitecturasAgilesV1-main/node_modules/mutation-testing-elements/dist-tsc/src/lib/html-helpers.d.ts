...
export declare function getEmojiForTestStatus(status: TestStatus): import("lit-html").TemplateResult<1>;
export declare function getEmojiForStatus(status: MutantStatus): import("lit-html").TemplateResult<1>;
